...
<head>
    ...
    <title>Yearly Rent Bills Report</title>
    <style>
...
<body>
    ...
    <div class="print-header">
        <div class="print-title">
            ...
            <span class="print-pill">
                Yearly Report {{ $year }}{{ $tenant ? ' - ' . $tenant->client_name : '' }}
            </span>
        </div>
    </div>
    ...
    <table class="print-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td class="text-center" colspan="10">No bills found for this tenant and year.</td>
                </tr>
            @endforelse
        </tbody>
        @if ($rows->isNotEmpty())
